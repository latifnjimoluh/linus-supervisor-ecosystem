...
VALUES
  ...
  ('serviceTemplate.create', 'Créer un script de configuration de service', 'actif', NOW(), NOW()),
  ('serviceTemplate.read', 'Consulter les scripts de configuration de service', 'actif', NOW(), NOW()),
  ('serviceTemplate.update', 'Mettre à jour un script de configuration de service', 'actif', NOW(), NOW()),
  ('serviceTemplate.delete', 'Supprimer un script de configuration de service', 'actif', NOW(), NOW()),
...
WHERE p.name IN (
  ...
  'serviceTemplate.create','serviceTemplate.read','serviceTemplate.update','serviceTemplate.delete',
