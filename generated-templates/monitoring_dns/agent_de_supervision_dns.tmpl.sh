...
(crontab -l 2>/dev/null; echo "*/{{CRON_INTERVAL}} * * * * /opt/agent-superviseur-dns.sh > /dev/null") | crontab -

echo "🛠️ Installation du serveur DNS (bind9)..."
echo "✅ Installation du superviseur DNS pour la zone {{ZONE_NAME}} terminée."