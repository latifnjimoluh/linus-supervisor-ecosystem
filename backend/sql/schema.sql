...
SELECT pg_catalog.setval('public.ai_cache_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.deployments_id_seq', 40, true);
...
SELECT pg_catalog.setval('public.logs_id_seq', 3024, true);
...
SELECT pg_catalog.setval('public.monitorings_id_seq', 12, true);
